> **⚠️ Provenance-снимок, не документация.**
> Это нетронутый шаблонный README реального проекта владельца на Mos.Hub
...
```
cd existing_repo
git remote add origin https://hub.mos.ru/sayone/saymer.git
git branch -M main
...
- [ ] [Настройте интеграцию](https://hub.mos.ru/sayone/saymer/-/settings/integrations)
